...
<?php
  ...
  $sql = "SELECT * FROM tbl_emp_list WHERE empstatus='Contractual'" . $queryCondition;
  $href = 'contractualemployees.php';          
...
<h3>List of Contractual Employees</h3>
...
<div id="toys-grid">      
      <form name="frmSearch" method="post" action="contractualemployees.php" id="myTable">

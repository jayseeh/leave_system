...
<?php
  ...
  $sql = "SELECT * FROM tbl_emp_list WHERE empstatus='Regular'" . $queryCondition;
  $href = 'regularemployees.php';          
...
<h3>List of Regular Employees</h3>
        ...
        <tbody>
          ...
          <td><?php echo $result[$k]["position"]; ?></td>
            <td align="center" width="80px">
              <button data-toggle="modal" type="button" data-target="#regular_modal<?php echo $result[$k]['empID']?>" ><img src="image/view.png" width="18px"></button>
